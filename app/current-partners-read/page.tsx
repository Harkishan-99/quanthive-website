...
export default function CurrentPartnersReadPage() {
      ...
      <main>
        <section className={styles.hero}>
          <div className={styles.heroContent}>
            ...
            <h1 className={styles.projectTitle}>Current Partners</h1>
          </div>
        </section>
        ...
        <section ref={mainImageRef} className={styles.mainImage}>
          <div className={styles.imageWrapper}>
            <img
              src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?ixlib=rb-4.0.3&auto=format&fit=crop&w=2012&q=80"
              ...
              onError={(e) => {
                ...
                img.src = "https://images.unsplash.com/photo-1521737604893-d14cc237f11d?ixlib=rb-4.0.3&auto=format&fit=crop&w=2012&q=80";
              }}
            />
          </div>
        </section>
        ...
        <section className={styles.visionContent}>
          <div className={styles.visionContentWrapper}>
            <p className={styles.visionText}>
              Collaborations that compound advantage—partners aligned with the
              principles of transparency, auditability, and scale.
            </p>
          </div>
        </section>
      </main>
