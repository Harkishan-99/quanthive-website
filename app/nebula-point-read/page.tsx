...
export default function NebulaPointReadPage() {
  ...
  return (
    <div ref={containerRef} className={styles.container}>
      ...
      <main>
        <section className={styles.hero}>
          <div className={styles.heroContent}>
            <p className={styles.projectType}>Cosmic Journey</p>
            <h1 className={styles.projectTitle}>Nebula Point</h1>
          </div>
        </section>
        ...
        <section ref={mainImageRef} className={styles.mainImage}>
          <div className={styles.imageWrapper}>
            <img
              src="https://images.unsplash.com/photo-1444703686981-a3abbc4d4fe3?ixlib=rb-4.0.3&auto=format&fit=crop&w=2012&q=80"
              alt="Nebula Point"
              loading="eager"
              ...
              onError={(e) => {
                ...
                img.src = "https://images.unsplash.com/photo-1472214103451-9374bd1c798e?ixlib=rb-4.0.3&auto=format&fit=crop&w=2012&q=80";
              }}
            />
          </div>
        </section>
        ...
        <section className={styles.visionContent}>
          <div className={styles.visionContentWrapper}>
            <p className={styles.visionText}>
              Exploring the frontier—new vectors of research and market insight
              where discovery meets rigor.
            </p>
          </div>
        </section>
      </main>
      ...
      <section className={styles.nextSection}>
        ...
        <h2 className={styles.nextTitle}>Horizon</h2>
        <button
          ...
          onClick={() => {
            gsap.to(containerRef.current, {
              ...
              duration: 0.4,
              ease: "power2.out",
              onComplete: () => router.push("/about/horizon-read"),
            });
          }}
        >
